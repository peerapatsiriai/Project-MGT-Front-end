...
//================================= Section Active =============================//
import Section_Active from '@/components/Instructor_project/Section_Active';
import Project_In_Section from '@/components/Instructor_project/Section_Active/Project_In_Section';
import Project_Insec_Detail from '@/components/Instructor_project/Section_Active/Project_In_Section/Project_Insec_Detail';
import Select_pre_project_transfer from '@/components/Instructor_project/Section_Active/Select_pre_project_transfer';
...
export default function Instructor_project() {
  ...
  const [projectIdData, setProjectIdData] = useState([]); // Send Project ID data across properties
  const [sectionIdData, setSectionIdData] = useState([]); // Send Section id data across properties
        ...
        >
          ...
          <div className='flat-tabs'>
            ...
            <div className='content-tabs'>
              ...
              {/* Section Active table Managment */}
              <div
                id='market'
                className={activeIndex === 3 ? 'tabcontent active' : 'tabcontent'}
              >
                <Section_Active
                  activeIndex={activeIndex}
                  setActiveIndex={setActiveIndex}
                  setSectionIdData={setSectionIdData}
                />
              </div>
              <div
                id='market'
                className={activeIndex === 3.1 ? 'tabcontent active' : 'tabcontent'}
              >
                <Project_In_Section
                  activeIndex={activeIndex}
                  setActiveIndex={setActiveIndex}
                  sectionIdData={sectionIdData}
              ...
              <div
                id='market'
                className={activeIndex === 3.1_1 ? 'tabcontent active' : 'tabcontent'}
              >
                <Project_Insec_Detail
                  activeIndex={activeIndex}
                  setActiveIndex={setActiveIndex}
                  projectIdData={projectIdData}
                  setProjectIdData={setProjectIdData}
              ...
              <div
                id='market'
                className={activeIndex === 3.1_2 ? 'tabcontent active' : 'tabcontent'}
              >
                <Select_pre_project_transfer
                  activeIndex={activeIndex}
                  setActiveIndex={setActiveIndex}
                  sectionIdData={sectionIdData}
                />
