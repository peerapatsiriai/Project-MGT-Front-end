                        ...
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-12">
                                    <h1 className="heading text-center">Blog list #1</h1>
                                ...
                                <div className="wrap-inner col-md-8 col-12">
                                    <article className="tf-card-article">
                                        ...
                                        <div className="card-title">
                                            <h5 className="mt-18"><Link href="/item-details">A revelation about blockchain gaming</Link></h5>
                                        ...
                                        <div className="card-bottom flex items-center justify-between">
                                            <div className="author flex items-center justify-between">
                                                ...
                                                <div className="info">
                                                    <span>Posted by:</span>
                                                    <h6><Link href="/author-2">Ronald Richards</Link> </h6>
                                                </div>
                                            </div>
                                    ...
                                    <article className="tf-card-article">
                                        ...
                                        <div className="card-title">
                                            <h5 className="mt-18"><Link href="/item-details">Star Atlas Showroom 2.1: Massive ships and pretty skins</Link></h5>
                                            <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                        </div>
                                        <div className="card-bottom flex items-center justify-between">
                                            <div className="author flex items-center justify-between">
                                    ...
                                    <article className="tf-card-article">
                                        ...
                                        <div className="card-title">
                                            <h5 className="mt-18"><Link href="/item-details">Vision Pro: Apple’s mixed-reality headset is here</Link></h5>
                                            <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                        </div>
                                        <div className="card-bottom flex items-center justify-between">
                                            <div className="author flex items-center justify-between">
                                    ...
                                    <article className="tf-card-article">
                                        ...
                                        <div className="card-title">
                                            <h5 className="mt-18"><Link href="/item-details">New Shrapnel map to mix blossom and blood</Link></h5>
                                            <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                        </div>
                                        <div className="card-bottom flex items-center justify-between">
                                            <div className="author flex items-center justify-between">
                                    ...
                                    <article className="tf-card-article">
                                        ...
                                        <div className="card-title">
                                            <h5 className="mt-18"><Link href="/item-details">Meta sticks to guns with lighter, VR focussed Quest 3</Link></h5>
                                            <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                        </div>
                                        <div className="card-bottom flex items-center justify-between">
                                            <div className="author flex items-center justify-between">
