...
const AddProjectDocTemp = ({ activeIndex, setActiveIndex }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Button
          variant='h6'
          style={{ color: 'pink' }}
          onClick={() => handlePreview(params.row.ch_file_name)}
        >
          ...
        </Button>
      ),
    },
    {
      ...
      renderCell: (params) => (
        <Button
          variant='outlined'
          onClick={() => handleDownload(params.row.ch_file_name)}
        >
          ดาวน์โหลด
        </Button>
      ),
            ...
            >
              ...
              >
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem value={'CHAPTER01'}>CHAPTER01</MenuItem>
                    <MenuItem value={'CHAPTER02'}>CHAPTER02</MenuItem>
                    <MenuItem value={'CHAPTER03_PERSONAL'}>CHAPTER03_PERSONAL</MenuItem>
                    <MenuItem value={'CHAPTER03_GROUP'}>CHAPTER03_GROUP</MenuItem>
                    <MenuItem value={'CHAPTER04'}>CHAPTER04</MenuItem>
                    <MenuItem value={'CHAPTER05'}>CHAPTER05</MenuItem>
                    <MenuItem value={'CHAPTER06'}>CHAPTER06</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
            </Grid>
...
export default AddProjectDocTemp;
