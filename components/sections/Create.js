      ...
      <div className='wrapper-content-create'>
        ...
        <div className='widget-tabs relative'>
          <ul className='widget-menu-tab'>
            ...
            >
              <span className='inner'>
                <span className='order'>1</span> Upload your image <i className='icon-keyboard_arrow_right' />
              </span>
            </li>
            <li
            ...
            >
              <span className='inner'>
                <span className='order'>2</span>Description <i className='icon-keyboard_arrow_right' />
              </span>
            </li>
            <li
          ...
          <div className='widget-content-tab'>
            ...
            <div
              className={activeIndex === 3 ? 'widget-content-inner submit active' : 'widget-content-inner submit'}
