...
export default function Sec_Management({ activeIndex, setActiveIndex, crossSecData, setCrossSecData }) {
  // data variables
          ...
          >
            ...
            >
              <div
                className='tf-button style-1 type-1 tablinks'
                data-tabs='create'
                onClick={handlePreprojectSectionClick}
                style={{ cursor: 'pointer' }}
              >
                <span>Pre project section</span>
              </div>
            </div>
            {/* End Preproject Section Button */}
          </div>
